...
public abstract class Gramatica
{
	...
	{
		return ((0 <= numSimbolo) && (numSimbolo <= 113));
	}
	...
	{
		return ((114 <= numSimbolo) && (numSimbolo <= 207));
	}
	...
	{
		return ((6 <= numSimbolo) && (numSimbolo <= 5));
	}
